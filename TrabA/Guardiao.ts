...
// Instâncias
const guardiao1 = new Subterraneo("Basilisco", "Cobra", "Petrificar", Math.floor(Math.random() * 200)+1, "A câmara secreta");
...
// Instâncias
const guardiao2 = new Aracnideo("Aragogue", "Aranha", "Envenenar", Math.floor(Math.random() * 200)+1, "Hagrid");